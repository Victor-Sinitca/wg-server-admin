...
export const AddProduct: FC<AddProductType> = ({isTech}) => {
    ...
    return <div>
        <Formik
            initialValues={isTech ? initialTechValues : initialValues}
                ...
                <div>
                    <div>
                        ...
                        <Field as="select" id="type" name="filterModel.type">
                            ...
                            <option  disabled={!isTech} value="Technique">Technique</option>
                            <option disabled={isTech} value="Premium">Premium</option>
                            <option disabled={isTech} value="Gold">Gold</option>
                            <option disabled={isTech} value="Provisions">Provisions</option>
